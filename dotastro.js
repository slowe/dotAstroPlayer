...
(function ($) {
	...
	// Draw our necessary styles
	document.write('<style type="text/css">/* Set the "blue" styling */ .progress_bar .ui-slider-handle, .slides:hover .mainplay, .controls .play:hover, .controls .volume:hover, .controls .mute:hover, .controls .bandwidth:hover, .controls .fullscreen:hover, .bw.selected, .bw:hover { background: #474ff7; } .talk a img:hover { opacity: 1; filter: alpha(opacity=100); } .bw { cursor: pointer; display: inline-block; padding: 4px 8px; margin: 0 5px 15px 0; font-size: 1.2em; color:#fff; text-shadow:none; background:#c2c2c2; border-radius:3px; } .bwset { display: inline-block; }  .slides ul { list-style: none; margin: 0px!important; padding: 0px; } .slides ul li { height: auto; display: inline-block; } .slide { margin-bottom: 20px; padding: 0px; background-image: none; } .dotastrotalk .slides .slide .timestamp { margin-bottom: 1em; } .slide .pic img { width: auto; margin-bottom: 0px; } .dotastrotalk .slides .slide { z-index: 1; width: 100%; display: inline; } .dotastrotalk .slides .slide a img { display: block; } .dotastrotalk .slides .slide img { width: 100%!important; margin-bottom: 0px; } .dotastrotalk .slides .slide .timestamp { margin-bottom: 0em; } .dotastrotalk .slides .slide .pic img { width: 100%; margin-bottom: 0px; } .dotastrotalk .slides.fullscreen { width:100%!important; height:100%!important; } .dotastrotalk .slides.fullscreen .slide { height: 100%; display: block; } .dotastrotalk .slides.fullscreen .slide .pic { height: 100%; } .dotastrotalk .slides.fullscreen .slide a.big_slide img, .slides.fullscreen .slide video { width: auto; margin:auto; height: 100%; } .dotastrotalk .slides:after {content: none;} .dotastrotalk .slides { min-height: 65px; } .dotastrotalk .slide-holder.fullwidth { width: 100%!important; } .dotastrotalk .slides { background-color: black; height: auto; position: relative; } .dotastrotalk .slides ul { list-style: none; margin: 0px; padding: 0px; } .dotastrotalk .slides li { margin-bottom: 0px; list-style: none; } .dotastrotalk .endoftalk { display: none; } .dotastrotalk .overlay-splash { display: table-cell; vertical-align: middle; position: absolute; left: 0px; top: 0px; z-index: 100; } .dotastrotalk .overlay-controls { display: inline-block; position: absolute; bottom: 0px; z-index: 99; }  .dotastrotalk .play, .dotastrotalk .slides .mainplay { cursor: pointer; background-color: rgba(0,0,0,0.6); } .dotastrotalk .slides .mainplay, .dotastrotalk .slides .mainplay img { transition-property: background-color, opacity; transition-duration: 1s; -moz-transition-property: background-color, opacity; -moz-transition-duration: 1s; -o-transition-property: background-color, opacity; -o-transition-duration: 1s; -webkit-transition-property: background-color, opacity; -webkit-transition-duration: 1s; } .dotastrotalk .slides .mainplay { border: 1px solid #d1d1d1; border-left: 0px; margin-top: 200px; display: inline-block; } .dotastrotalk .slides:hover .mainplay img { opacity: 1; cursor: pointer; } .dotastrotalk .slides .mainplay img { opacity: 0.7; border-left: 0px; display: block; margin: 0px; padding: 0px; line-height: 0px; } .dotastrotalk video { margin: 0px; display: block; }  .dotastrotalk .messages { clear: both; max-width: 100%; margin-left: 0px; } .dotastrotalk .messages ul { list-style: none; margin: 0px; padding: 0px; }  .dotastrotalk .controls { position: absolute; bottom: 0px; left: 0px; width: 100%; } .dotastrotalk .controls .play { float: left; margin: 0px; width: 65px; height: 65px; } .dotastrotalk .controls .play img { margin: 0px; height: 65px; } .dotastrotalk .controls_right { float: right; width: 100%; height: 65px; background-color: rgba(0,0,0,0.6); } .dotastrotalk .controls_row { height: 32px; margin: 0 4px; } .dotastrotalk .controls .volume, .dotastrotalk .controls .bandwidth, .dotastrotalk .controls .fullscreen, .dotastrotalk .controls .clock, .dotastrotalk .controls .mute { display: inline-block; } .dotastrotalk .controls .progress { width: 100%; height: 28px; display: inline-block; } .dotastrotalk .controls .progress_outer { margin: 8px 10px; } .dotastrotalk .controls .progress_inner { background: rgba(255,255,255,0.8); padding: 0 8px; } .dotastrotalk .ui-slider { position: relative; text-align: left; height: 12px; } .dotastrotalk .ui-slider .ui-slider-handle { margin-left: -8px; height: 12px; position: absolute; width: 16px; z-index: 2; } .dotastrotalk .controls .fullscreen { width: 32px; height: 32px; } .dotastrotalk .controls .clock { height: 32px; line-height: 16px; position: absolute; top: 0px; margin: 8px; text-shadow: none; color: rgba(255,255,255,0.8); } .dotastrotalk .controls .mute { width: 32px; height: 32px; } .dotastrotalk .controls .volume { width: 32px; height: 32px; } .dotastrotalk .controls .bandwidth { width: 32px; height: 32px; display: none; } .dotastrotalk .controls .bandwidth.selected { display: inline-block; } .dotastrotalk .controls .play:hover, .dotastrotalk .controls .volume:hover, .dotastrotalk .controls .mute:hover, .dotastrotalk .controls .bandwidth:hover, .dotastrotalk .controls .fullscreen:hover { cursor: pointer; }  @media only screen and (max-width: 959px){ 	.dotastrotalk .slides { width: 100%; max-width: 100%!important; max-height: 100%; height: auto; display: block; } 	.dotastrotalk .messages { display: block; margin-left: 0px; width: 100%; } 	.dotastrotalk video { max-width: 100%; } 	.dotastrotalk .messages ul { margin-left: 0px; height: auto; } }</style>');
